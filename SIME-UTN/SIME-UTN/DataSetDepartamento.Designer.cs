...
namespace SIME_UTN.DataSetDepartamentoTableAdapters {
    ...
    public partial class DepartamentoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Departamento] WHERE (([IDDepartamento] = @Original_IDDepartamento) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ((@IsNull_Estado = 1 AND [Estado] IS NULL) OR ([Estado] = @Original_Estado)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Departamento] SET [Descripcion] = @Descripcion, [Estado] = @Estado WHERE (([IDDepartamento] = @Original_IDDepartamento) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ((@IsNull_Estado = 1 AND [Estado] IS NULL) OR ([Estado] = @Original_Estado)));
SELECT IDDepartamento, Descripcion, Estado FROM Departamento WHERE (IDDepartamento = @IDDepartamento)";
        ...
        public virtual int Fill(DataSetDepartamento.DepartamentoDataTable dataTable) {
        ...
        public virtual DataSetDepartamento.DepartamentoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetDepartamento.DepartamentoDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetDepartamento dataSet) {
        ...
        public virtual int Update(string Descripcion, global::System.Nullable<bool> Estado, int Original_IDDepartamento, string Original_Descripcion, global::System.Nullable<bool> Original_Estado, int IDDepartamento) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(IDDepartamento));
