...
namespace SIME_UTN.DataSets.Bodega.Admistracion.DataSetFuncionarioTableAdapters {
...
SELECT IDFuncionario, Nombre, Cedula, Telefono, Correo, IDDepartamento, Estado FROM Funcionario WHERE (IDFuncionario = SCOPE_IDENTITY()) ORDER BY IDFuncionario DESC";
...
SELECT IDFuncionario, Nombre, Cedula, Telefono, Correo, IDDepartamento, Estado FROM Funcionario WHERE (IDFuncionario = @IDFuncionario) ORDER BY IDFuncionario DESC";
