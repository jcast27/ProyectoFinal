...
namespace SIME_UTN.DataSets.Bodega.Admistracion {
    ...
    public partial class DataSetProductos : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string CodigoAvatar, string Nombre, string Descripcion, int IDCategoria, int IDUnidadMedida, bool Estado) {
...
namespace SIME_UTN.DataSets.Bodega.Admistracion.DataSetProductosTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Producto] WHERE (([IDProducto] = @Original_IDProducto) AND ((@IsNull_CodigoAvatar = 1 AND [CodigoAvatar] IS NULL) OR ([CodigoAvatar] = @Original_CodigoAvatar)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ([IDCategoria] = @Original_IDCategoria) AND ([IDUnidadMedida] = @Original_IDUnidadMedida) AND ((@IsNull_Estado = 1 AND [Estado] IS NULL) OR ([Estado] = @Original_Estado)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Producto] ([CodigoAvatar], [Nombre], [Descripcion], [IDCategoria], [IDUnidadMedida], [Estado]) VALUES (@CodigoAvatar, @Nombre, @Descripcion, @IDCategoria, @IDUnidadMedida, @Estado);
SELECT IDProducto, CodigoAvatar, Nombre, Descripcion, IDCategoria, IDUnidadMedida, Estado FROM Producto WHERE (IDProducto = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Producto] SET [CodigoAvatar] = @CodigoAvatar, [Nombre] = @Nombre, [Descripcion] = @Descripcion, [IDCategoria] = @IDCategoria, [IDUnidadMedida] = @IDUnidadMedida, [Estado] = @Estado WHERE (([IDProducto] = @Original_IDProducto) AND ((@IsNull_CodigoAvatar = 1 AND [CodigoAvatar] IS NULL) OR ([CodigoAvatar] = @Original_CodigoAvatar)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ([IDCategoria] = @Original_IDCategoria) AND ([IDUnidadMedida] = @Original_IDUnidadMedida) AND ((@IsNull_Estado = 1 AND [Estado] IS NULL) OR ([Estado] = @Original_Estado)));
SELECT IDProducto, CodigoAvatar, Nombre, Descripcion, IDCategoria, IDUnidadMedida, Estado FROM Producto WHERE (IDProducto = @IDProducto)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        IDProducto, CodigoAvatar, Nombre, Descripcion, IDCategoria, IDUnida" +
                "dMedida, Estado\r\nFROM            Producto";
        ...
        public virtual int Delete(int Original_IDProducto, string Original_CodigoAvatar, string Original_Nombre, string Original_Descripcion, int Original_IDCategoria, int Original_IDUnidadMedida, global::System.Nullable<bool> Original_Estado) {
        ...
        public virtual int Insert(string CodigoAvatar, string Nombre, string Descripcion, int IDCategoria, int IDUnidadMedida, global::System.Nullable<bool> Estado) {
        ...
        public virtual int Update(string CodigoAvatar, string Nombre, string Descripcion, int IDCategoria, int IDUnidadMedida, global::System.Nullable<bool> Estado, int Original_IDProducto, string Original_CodigoAvatar, string Original_Nombre, string Original_Descripcion, int Original_IDCategoria, int Original_IDUnidadMedida, global::System.Nullable<bool> Original_Estado, int IDProducto) {
            if ((CodigoAvatar == null)) {
            ...
            if ((Original_CodigoAvatar == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_CodigoAvatar));
            }
            if ((Original_Nombre == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_IDCategoria));
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CodigoAvatar, string Nombre, string Descripcion, int IDCategoria, int IDUnidadMedida, global::System.Nullable<bool> Estado, int Original_IDProducto, string Original_CodigoAvatar, string Original_Nombre, string Original_Descripcion, int Original_IDCategoria, int Original_IDUnidadMedida, global::System.Nullable<bool> Original_Estado) {
            return this.Update(CodigoAvatar, Nombre, Descripcion, IDCategoria, IDUnidadMedida, Estado, Original_IDProducto, Original_CodigoAvatar, Original_Nombre, Original_Descripcion, Original_IDCategoria, Original_IDUnidadMedida, Original_Estado, Original_IDProducto);
        }
    }
