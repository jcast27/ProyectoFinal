...
namespace SIME_UTN.DAL
{
    class UbicacionDAL
    {
            ...
            using (DataBase db = DataBaseFactory.CreateDataBase("default", UsuarioDB.GetInstance().usuario, UsuarioDB.GetInstance().contrasenna))
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    try
                    {
                        ...
                        unUbicacion.idDepartamento = Convert.ToInt32(dr["IDDepartamento"].ToString());
        ...
        public static void GuardarUbicacion(Ubicacion Ubicacionp)
        {
            ...
            comando.Parameters.AddWithValue("@IDDepartamento", Ubicacionp.idDepartamento);
        ...
        public static Ubicacion ObtenerUbicacionID(int idUbicacionp)
        {
            ...
            using (DataBase db = DataBaseFactory.CreateDataBase("default", UsuarioDB.GetInstance().usuario, UsuarioDB.GetInstance().contrasenna))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    unUbicacion.idDepartamento = Convert.ToInt32(ds.Tables[0].Rows[0]["IDDepartamento"].ToString());
